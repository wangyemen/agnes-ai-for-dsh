...
moduleLoader.load({
  ...
  factory: (require: any) => {
    ...
    function Badge(props: { children: any; tone?: 'default' | 'green' | 'amber' | 'blue' | 'purple' | 'red' }) {
    ...
    function SectionTitle(props: { children: any; subtitle?: string }) {
      return jsxs('div', {
    ...
    function ModelCard(props: { model: AgnesModelInfo; configured: boolean }) {
    ...
    function StatusBadge(props: { status: string }) {
      const map: Record<string, { tone: 'default' | 'green' | 'amber' | 'blue' | 'red'; label: string }> = {
    ...
    function RecordCard(props: { record: any; onDelete: (id: string) => void }) {
    ...
    function GenerationRecordsPanel(props: { scope: any }) {
      const { scope } = props
      ...
      React.useEffect(() => {
        ...
        let dispose: any
        try {
          if (typeof scope.subscribe === 'function') dispose = scope.subscribe(load)
        } catch (e) {
          // eslint-disable-next-line no-console
      ...
      return jsxs('div', {
        children: [
          ...
          jsx('div', {
            ...
            children: pageRecords.map((r: any) =>
              jsx(RecordCard, { record: r, onDelete: handleDelete }, String(r.id)),
            ),
          }),
    ...
    function apply(ctx: any): void {
      ...
      function AgnesPanel(_props: any) {
        ...
        const configuredModelsRaw: any[] = Array.isArray(config.models) ? config.models : []
        const configuredIds = new Set<string>(configuredModelsRaw.map((m: any) => String(m.id)))
